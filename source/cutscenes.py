...
def get_cutscene(game, type, cutscenes, screen):
    ...
    if type == "Intro":
        ...
        Cutscenes["Intro"]["2"] = Cutscene(game, cutscenes[type]["2"][0], (100, 380), 40, 20, screen, cutscenes[type]["2"][1])       
        ...
        Cutscenes["Ending"]["10"] = Cutscene(game, cutscenes[type]["10"][0], (110, 250), 60, 80, screen, cutscenes[type]["10"][1]) 
