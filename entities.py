...
# class Enemy(PhysicsEntity):
    ...
    #     if self.flip:
    #         surf.blit(pygame.transform.flip(self.game.assets['gun'], True, False), (self.rect().centerx - 4 - self.game.assests['gun'].get_width() - offset[0], self.rect().centery - offset[1]))
    #     else:
